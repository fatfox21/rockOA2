...
var grids,form;
var frompanel={
	submitfields:'money,moneycn,explain,applydt,bills,fullname,paytype,cardid,openbank,purpose,purresult',labelWidth:100,url:publicsave('finsave','finasys'),aftersaveaction:'fybxsave',
	params:{otherfields:'type=1'},
	items:[{
		...
		fieldLabel:'出差目的',name:'purposePost',allowBlank: false
	},{
		fieldLabel:'出差成果',name:'purresultPost',allowBlank: false
	},{
		xtype: 'fieldcontainer',defaultType: 'textfield',layout:'hbox',items:[{
		...
		items:{
			...
			columns:[{
				...
				text:'*发生地点',dataIndex:'address',editor:'textfield',width:150
			},{
				text:'*所属项目',dataIndex:'items',width:120,editor:{xtype:'optioncombo',optionmnum:'finaitems'}
			},{
