...
var panel=[{
	xtype:'rockgrid',region:'west',width:200,keywhere:'and `type`=0 and `mid`=0',split:true,bbarbool:false,defaultorder:'sort',
	tablename:'kq_set',storefields:'id,recename,name',
	columns:[{
		xtype: 'rownumberer',
		width: 40
	},{
	...
	region:'center',storefields:'id,name,type,sort,stime,etime,dt',
	...
	columns:[{
		...
		text:'针对日期',dataIndex:'dt',autowidth:true
	},{
		...
		text:'排序号',dataIndex:'sort',width:'15%'
	}],
	...
	formparams:{
		...
		items:[{
			...
			fieldLabel:'针对日期',name:'dtPost',xtype:'datefield',format:'Y-m-d'
		},{
