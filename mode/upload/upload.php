...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td align="left"><button type="button" id="addbtn" onClick="up.add()">＋添加文件</button>&nbsp; <button type="button" id="clearbtn" onClick="up.clear()">－清除所有文件</button>&nbsp; <button type="button" onClick="window.close()">关闭</button></td>
